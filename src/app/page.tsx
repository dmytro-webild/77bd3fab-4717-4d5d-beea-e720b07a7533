...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        ...
        {
          name: "Amit M.",          handle: "@amitm",          testimonial: "Great quality and professional handling. Highly recommended.",          rating: 5,
        ...
        {
          name: "Priya S.",          handle: "@priyas",          testimonial: "Consistent taste and very reliable delivery time.",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/low-angle-male-friends-restaurant_23-2148395368.jpg"},
        {
          name: "Vikram D.",          handle: "@vikramd",          testimonial: "Fantastic variety and great taste. Will order again!",          rating: 5,
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/male-pouring-ketchup-burger-buns_7502-9667.jpg",          alt: "Customer profile one"},
        {
          src: "http://img.b2bpic.net/free-photo/sushi-chef-cutting-fish-making-sushi_259150-58575.jpg",          alt: "Customer profile two"},
        {
          src: "http://img.b2bpic.net/free-photo/front-view-delicious-food-arrangement_23-2148510869.jpg",          alt: "Customer profile three"},
        {
          src: "http://img.b2bpic.net/free-photo/chef-showing-his-fine-cuisine-professional-food-decoration_482257-10348.jpg",          alt: "Customer profile four"},
        {
          src: "http://img.b2bpic.net/free-photo/top-view-delicious-muffins-with-honey-choco-biscuits-light-background_140725-125512.jpg",          alt: "Customer profile five"},
      ]}
      ...
      marqueeItems={[
        ...
        {
          type: "text",          text: "Chef-Prepared"},
        {
          type: "text",          text: "Fast Delivery"},
        {
          type: "text",          text: "100% Fresh"},
        {
          type: "text",          text: "Igatpuri's Finest"},
      ]}
    />
  </div>
      ...
      features={[
        {
          ...
          items: [
            {
              text: "Safe drop-off",              icon: Shield,
            },
            {
        ...
        },
        {
          ...
          items: [
            {
              text: "Daily changing specials",              icon: Sparkles,
            },
            {
              text: "Authentic recipes",              icon: CheckCircle,
            },
          ],
          reverse: true,
        },
        {
          ...
          items: [
            {
              text: "Value meals",              icon: Award,
            },
            {
              text: "Bulk order discounts",              icon: Star,
            },
          ],
          reverse: false,
        },
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        {
          id: "p3",          name: "Mini Appetizer",          price: "₹149",          imageSrc: "http://img.b2bpic.net/free-photo/male-hands-with-food-tablet-computer_23-2147826923.jpg"},
        {
        ...
        {
          id: "p5",          name: "Deluxe Dessert",          price: "₹99",          imageSrc: "http://img.b2bpic.net/free-photo/top-view-pancakes-with-black-red-currants-strawberries-with-fork-knife-plate-white-checkered-towel_141793-12330.jpg"},
        {
          id: "p6",          name: "Fresh Juice/Beverage",          price: "₹79",          imageSrc: "http://img.b2bpic.net/free-photo/bottles-smoothies-table_23-2148037192.jpg"},
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        {
          id: "t1",          name: "Rahul P.",          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-woman-with-delicious-cocktail_23-2150166104.jpg"},
        {
          id: "t2",          name: "Sneha K.",          imageSrc: "http://img.b2bpic.net/free-photo/closeup-charming-delighted-cute-female-customer-give-positive-feedback-show-thumbsup-like-gesture-sm_1258-131745.jpg"},
        {
          id: "t3",          name: "Amit M.",          imageSrc: "http://img.b2bpic.net/free-photo/feedback-comment-survey-support-response-bar-word_53876-121002.jpg"},
        {
          id: "t4",          name: "Priya S.",          imageSrc: "http://img.b2bpic.net/free-photo/view-hand-holding-tasty-salad-served-with-chopped-cucumber-notebook-mixed-color-background_140725-139267.jpg"},
        {
          id: "t5",          name: "Vikram D.",          imageSrc: "http://img.b2bpic.net/free-photo/waitress-bringing-man-order-cafe_23-2147826930.jpg"},
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "f1",          title: "Do you deliver to my area?",          content: "Yes, we serve the entire Igatpuri region."},
        {
          id: "f2",          title: "What are your hours?",          content: "We operate until 2:00 AM daily."},
        {
          id: "f3",          title: "Can I bulk order?",          content: "Absolutely! Reach out to us on WhatsApp for orders."},
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      textarea={{
        name: "message",        placeholder: "Your Order or Questions",        rows: 4,
      }}
